...
We fit a weibull survival model to estimate \lambda, the extinction rate of the subpopulations used in our experiment. The weibull model is an extension of an exponential decay model, and includes an additional shape parameter, which allows \lambda to vary across generations of inbreeding.
...
nl_p1 <-
 ...
 # geom_smooth(size = 1.5, colour = met.brewer("OKeeffe2")[7], alpha = 0.4) +
  ...
  labs(y = "Subpopulation productivity", x = "Generation of inbreeding", fill = "Selection response\nhistory") +
  theme(text = element_text(size = 14),
        legend.title = element_text(size = 12),
        legend.text = element_text(size = 11),
